layui.use(['layer','jquery'], function(){
    ...
    var limit=2;
    //加载查询结果
    loadSearchResult(goodName,page,limit);
    //加入购物车
    addCar();
    //首页
    ...
    //加载查询结果
    function loadSearchResult(goodName,page,limit) {
     $.ajax({
         url:"/goods/getGoodByGoodName",
         data:{"goodName":goodName,"page":page,"limit":limit},
         async:false,
         type:"post",
         error:function () {
             layer.msg("服务器异常");
